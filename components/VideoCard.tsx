export default function VideoCard({ href, length, title, index }) {
  return (
    ...
    >
      <div className="w-full border-b border-gray-200 dark:border-gray-700 py-3 transform hover:br-primary-light transition-all">
        <div className="flex flex-col sm:flex-row justify-between items-baseline ">
          ...
          <div className="flex items-center mt-2 sm:mt-0 w-full sm:w-auto justify-between">
            <p className="text-th-primary-dark text-left sm:text-right w-32 md:mb-0 mr-2 ml-10 sm:ml-0">
              {length}
            </p>
            <svg
