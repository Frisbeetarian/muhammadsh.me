    ...
    >
      <div className="flex flex-col items-start justify-center max-w-4xl 2xl:max-w-4xl mx-auto mb-16">
        ...
        <p className="mb-4 text-gray-600 dark:text-gray-400">
          ...
          and does not rely on any closed/non-open-source third party service or
          package for any of its functionality. The primary development
          objective that I had in mind when building the platform was to see
          whether I could build all the systems required by hand, while learning
          Typescript/Graphql/React in the process. As for the systems that I'm
          too dumb to build or would require an inordinate amount of time to
          develop (like properly functioning video conferencing) I would solely
          rely on open source packages and libraries. From authentication, to
          the real time communication, to the presence system, etc... all would
          be built by me or would be provided by established open source
          packages/libraries. The only closed third parties that I would have to
          rely on of course would be the infrastructure providers. For this I
          went with Digital Ocean for the backend and its microservices and
          Vercel for the client.
        </p>

        <p className="mb-4 text-gray-600 dark:text-gray-400">
          I started building the first version of Noon in 2018-2019 using
          Laravel and Vuejs. I stopped working on it due obligations with work,
          freelance projects and the country (I'm from Lebanon) absolutely going
          up in flames in late 2019. A severe economic crisis brought on by a
          ruling mafia that stole the Lebanese's savings. All my, and my parents
          savings were locked in the banks, unable to be retrieved. Running out
          of cash on hand and with my freelance projects all brought to a
          screeching halt due to that same liquidity crisis, I urgently had to
          find employment and a steady source of income and was extremely lucky
          to be picked up by Myki in early 2020.
        </p>
        ...
        <p className="mb-4 text-gray-600 dark:text-gray-400">
          ...
          JS/TS and use all the accompanying ecosystem of open source packages.
        </p>

        <p className="mb-4 text-gray-600 dark:text-gray-400">
          Noon provides the features that people have come to expect from
          traditional communication and messaging platforms. From private/group
          chat, to media sharing in conversations, to video conferencing, etc...
          It is very much still in a very early stage of development, about 60%
          to 65% done. All the vital components are now functional; from the
          communication, authentication, presence systems to the video
          conferencing. But still require a shitload of enhancements,
          optimizations and debugging. The platform is live on{' '}
          <a
        ...
        <p className="mb-4 text-gray-600 dark:text-gray-400">
          ...
          for handling GraphQL queries and mutations, allowing for efficient and
          flexible data retrieval and manipulation. Real-time functionality is
          implemented using Socket.io for bi-directional communication between
          the client and server. Redis, as well as being as a caching layer, is
          also being used to store user sessions when users authenticate as well
          as Socket.io sessions and messages. PostgreSQL is used as the primary
          relational database for storing user and conferencing data. Neo4j is
          utilized for handling profile relationships, allowing for easy
          ...
          technologies work together to provide a robust and scalable backend
          for handling a variety of features such as user management, social
          networking/conferencing, and search functionality.
        </p>

        <p className="mb-4 text-gray-600 dark:text-gray-400">
          The Noon backend is designed as a set of microservices, rather than a
          monolithic application. The microservices communicate with each other
          using RabbitMQ as a message broker, utilizing the AMQP protocol for
          efficient and reliable message passing. Each microservice is
          responsible for a specific set of functionality, allowing for
          increased scalability and maintainability. The microservices include:
        </p>
        ...
        <ul className="mb-4 text-gray-600 dark:text-gray-400 ml-4">
          <li className="mb-4">
            ...
            <p className="ml-4 mb-4">
              ...
              runtime environment and Express to serve the static media content.
              The media microservice is responsible for handling all
            ...
            <p className="ml-4 mb-4">
              ...
              service to handle large amounts of data. Additionally, by writing
              the files to the file system, the media can be easily backed up
              and restored in case of any data loss.
            </p>

            <p className="ml-4 mb-4">
              I have defined routes that correspond to the URLs where the media
              files are stored. When a user requests a media file by accessing
              the corresponding URL, Express intercepts the request and
              retrieves the corresponding media file from the file system. Once
              the file is retrieved, Express sends it to the user's browser,
              allowing them to view or download the media.
            </p>
            ...
            <p className="ml-4 mb-4">
              ...
              This will allow me to easily adjust the size of the VPS to handle
              increases in load by scaling the number of replicas of the
              container.
            </p>

            <p className="ml-4 mb-4">
              To protect media access, I have used nginx as a reverse proxy. By
              using nginx as a reverse proxy, I can control access to the media
              by setting up authentication and access control. This ensures that
              only authorized users can access the media, and helps to protect
            ...
            <p className="ml-4 mb-4">
              ...
              media microservice that can handle a large number of media files,
              providing a smooth and responsive user experience while ensuring
              the security and protection of the media.
            </p>
          ...
          <li className="mb-4">
            ...
            <p className="ml-4 mb-4">
              The remote procedure call (RPC) package is a custom-built package
              written in Typescript that handles all communication between the
              microservices. It has two main modules: the client module and the
              server module.
            </p>
            ...
            <p className="ml-4 mb-4">
              ...
              by sending a message to a specific queue. The message contains the
              information needed for the other service to process the request,
              such as the method to be called and any necessary parameters.
            </p>
            ...
            <p className="ml-4 mb-4">
              ...
              This module listens to the queues and responds to the messages by
              sending ACKs (acknowledgements) to the corresponding queues. The
              ACKs contain the results of the requested operation or any errors
            ...
            <p className="ml-4 mb-4">
              ...
              able to respond within the specified time, the package will retry
              the request after a certain interval of time. This feature makes
              the Noon RPC package more robust and fault-tolerant.
            </p>
          ...
          <li className="mb-4">
            ...
            <p className="ml-4 mb-4">
              ...
              chosen for its versatility and ease of deployment. The platform is
              built on top of WebRTC, a technology that allows for real-time
              communication through web browsers. This eliminates the need for
              users to install any additional software, making it easily
              accessible for anyone with a web browser.
            </p>

            <p className="ml-4 mb-4">
              To deploy Jitsi, a DigitalOcean droplet was provisioned and
              configured. This droplet, or virtual private server, was set up to
              run Ubuntu, the operating system recommended by Jitsi. The Jitsi
              package was then installed on the droplet, along with any
            ...
            <p className="ml-4 mb-4">
              ...
              SSL certificate was obtained and configured for the Jitsi domain.
              Firewall rules were also set up to restrict access to the Jitsi
              server and to only allow necessary traffic. Although, for now,
              access is unrestricted for development and testing purposes. You
              can access the Jitsi instance running on the VPS by following the
              dedicated Noon domain on{' '}
              <a
        ...
        <div className="flex w-full">
          <h3 className="mt-8 mb-4 text-2xl font-bold tracking-tight text-black md:text-4xl dark:text-white justify-center items-center">
            <a
              className="underline flex items-center justify-center "
        ...
        <p className="mb-4 text-gray-600 dark:text-gray-400">
          ...
          handle queries and mutations. GraphQL Codegen is used to automatically
          generate the GraphQL syntax, reducing the need for manual type
          definitions. The design of the platform is implemented with Chakra UI,
          a popular library for building accessible, modular, and customizable
          UI components. For styling, it uses TailwindCSS, a utility-first CSS
          framework for rapidly building custom designs with a consistent look
          and feel. All these technologies are used together to create a
          high-performance and user-friendly client platform that seamlessly
          communicates with the API, providing a smooth and responsive user
          experience.
        </p>
        ...
        <p className="mb-4 text-gray-600 dark:text-gray-400">
          All state in the application is managed using Redux/Redux Toolkit. RTK
          allows for a centralized and predictable state management. Sure,
          adding complexity (vuex/pinia {'>>'} redux, I will fight over this)
          but without which using react context or a dedicated pub/sub mechanism
          for events would have been necessary, and that is a big nono in my
          eyes for anything resembling more than just simple state management.
        </p>

        <p className="mb-4 text-gray-600 dark:text-gray-400">
          I have used RTK to store the logged-in user, to populate the
          conversations, and to update the conversations with the messages sent
          amongst a myriad of other things. Additionally, I have also used it to
          handle various UI changes such as toggling the menu, displaying modals
          and toasts, and showing loading indicators. By using Redux, I can
          ensure that the state of the application is consistent and that all
          changes are handled in a predictable and consistent way.
        </p>
        ...
        <p className="ml-4 mb-4 text-gray-600 dark:text-gray-400">
        ...
        <p className="ml-4 mb-4 text-gray-600 dark:text-gray-400">
          ...
          : is responsible for storing and retrieving user authentication state.
          This includes information such as login credentials, session tokens,
        ...
        <p className="ml-4 mb-4 text-gray-600 dark:text-gray-400">
          ...
          tracking friend requests, blocked/unfriended, etc. It also keeps track
          of who the logged in user sent friend requests to and received friend
          requests from.
        </p>
        ...
        <p className="ml-4 mb-4 text-gray-600 dark:text-gray-400">
          ...
          : is responsible for managing the state of the user interface,
        ...
        <p className="ml-4 mb-4 text-gray-600 dark:text-gray-400">
          ...
          keeping track of their state, and handling any video-related errors or
          issues.
        </p>
        ...
        <p className="ml-4 mb-4 text-gray-600 dark:text-gray-400">
          I integrated the Jitsi package into the client by using the Jitsi Meet
          SDK. The Noon Video component initializes the connection via the React
          component provided by SDK to Videobridge2 on the VPS instance where
          Jitsi is configured and running. Once the connection is established,
          the component prepares an iframe to be embedded into the conversation
          window where the video call is requested.
        </p>
        ...
        <p className="mb-4 text-gray-600 dark:text-gray-400">
          When being built, a linting and verification process ensures that the
          code is free of any syntax or semantic errors before deployment. I'm
        ...
        <div className="flex flex-col md:flex-row w-full items-center md:items-start justify-around">
          <div className="mb-10 md:mb-0">
            <h4 className="w-full mb-2 text-lg font-medium text-gray-900 md:text-xl dark:text-gray-100 mb-5">
